...
class DslDirection<TEntity> {
    constructor(protected store: IterableStore<TEntity, any, any>, protected params: SelectionParams<TEntity, any>) { }
...
class DslBoundary<TEntity, TIndices extends keyof TEntity> extends DslDirection<TEntity> {
    ...
    constructor(store: IterableStore<TEntity, any, any>, params: SelectionParams<TEntity, any>) {
        super(store, params)
    }
...
class DslOver<TEntity, TIndices extends keyof TEntity> extends DslBoundary<TEntity, TIndices> {
    constructor(store: IterableStore<TEntity, any, any>, params: SelectionParams<TEntity, any>) { super(store, params) }
...
export class DslSkip<TEntity, TIndices extends keyof TEntity> extends DslOver<TEntity, TIndices> {
    ...
    skip(num: number): DslOver<TEntity, TIndices> {
        let builtParams: SelectionParams<TEntity, any> = { ...this.params, skip: num }
